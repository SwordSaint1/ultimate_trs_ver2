          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                		...
                		<div class="row">
 						...
 						<table>
 							<thead>
 								<tr>
 									<div class="col-sm-6">
 									<span for="">Requested Date From:</span> <input type="date" id="approve_suprequestDateFrom" class="form-control" value="<?=$server_date_only;?>" autocomplete=off>
 									</div>
 								</tr>
 								<tr>
 									<div class="col-sm-6">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn" onclick="load_approved_list_req_superior()">Search <i class="fas fa-search"></i></button> 
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0" style="height: 420px;">
                ...
                <tbody id="approved_data_superior" style="text-align:center;"></tbody>
                </table>
              </div>
              <!-- /.card-body -->
            </div>
