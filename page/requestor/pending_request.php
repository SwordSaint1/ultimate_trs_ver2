                		...
                		<div class="row">
 						<table>
 							<thead>
 								<tr>
 									<div class="col-sm-6">
 									<span for="">Request Date From:</span> <input type="date" id="pendingrequestDateFrom" class="form-control" value="<?=$server_date_month;?>" autocomplete=off>
 									</div>
 								</tr>
 								<tr>
 									<div class="col-sm-6">
 									<span for="">Request Date To:</span>  <input type="date" id="pendingrequestDateTo" class="form-control" value="<?=$server_date_only;?>" autocomplete=off>
 									</div>
 								</tr>
 							</thead>
 						</table>
