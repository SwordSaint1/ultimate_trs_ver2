          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> <span>Request Code:</span>     <input type="text" name="batch_number_approve_qualif" id="batch_number_approve_qualif" class="form-control-lg" readonly=""></h3>
