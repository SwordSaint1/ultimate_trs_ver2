...
<div class="modal fade bd-example-modal-xl" id="qualif_cancel" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <div class="row">
            ...
            <table>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                ...
                <tbody id="qualif_cancel_data_list" style="text-align: center;"></tbody>
                </table>
              </div>
              <!-- /.card-body -->
            </div>
